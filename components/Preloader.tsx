...
const Preloader = () => {
    ...
    return (
        <div className="fixed inset-0 z-[6] flex" ref={preloaderRef}>
            ...
            <p className="name-text flex text-[25vw] lg:text-[250px] font-cursive text-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 leading-none overflow-hidden text-white font-normal">
